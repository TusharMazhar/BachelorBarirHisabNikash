...
?>
	...
	<!-- &&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&-->
	 <br/> <br/> <br/> <br/>
	 <h1 class="logout5"><b>Update Advance Payment </b></h1>
...
//&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
	 ...
	 else
	 {
		 ...
		 $insertQuery="UPDATE advancepayment SET Date='$date ',Day=' $days ',Advance_Payment='$advancepayment',Email='$email ' Where   Email='$email' and Day=' $days' and  Date='$date'";          
...
?>
    <form method="POST" action="updateadvancepayment.php">
	<!--
	...
	<a href="profile.php" class="logout " style="background-color:black;color:red"> Go to Home page >><a/><br/><br/><br/>
    <div class="logout6">
       <?php echo $error ?>
    </div>
