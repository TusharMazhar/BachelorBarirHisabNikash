...
<html>
	<head>
	     	<title> Update Shopping Amount Entry </title>
...
?>
	...
	<!-- &&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&-->
	 <br/> <br/> <br/> <br/>
	 <h1 class="logout5"><b>Update Shopping Amount Entry </b></h1>
...
//&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
	 ...
	 else
	 {
		 ...
		 $insertQuery="Update  shoppingamountentry SET Date='$date ',Day=' $days ',Amount='$amount',Email='$email ' Where  Email='$email' and Day=' $days' and  Date='$date' ";        
...
?>
    <form method="POST" action="updateshoppingamountentry.php">
	<!--
	...
	<a href="updateshoppingdetails.php" class="logout " style="background-color:black;color:red"> Click next >><a/><br/><br/><br/>
    <div class="logout6">
       <?php echo $error ?>
    </div>
