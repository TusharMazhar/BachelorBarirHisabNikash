...
<html>
	<head>
	     	<title> Shopping Amount Entry </title>
...
?>
     <a href="updateshoppingamountentry.php" class="logout3" style="background-color:black;color:red"> Update Information  </a>
...
?>
	...
	<!-- &&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&-->
	 ...
	 <h1 class="logout5"><b> Shopping Amount Entry </b></h1>
...
//&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
	 ...
	 else
	 {
		 ...
		 $insertQuery="INSERT INTO shoppingamountentry (Date,Day,Amount,Email)  values ('$date ',' $days ','$amount','$email ')";          
...
?>
    <form method="POST" action="shoppingamountentry.php">
	<!--
	...
	<p class="logout4" style="color:red;font-family:Arial;font-weight:bold;font-size:23px;">Warning -- Must fill-up These Information !!<p/>
		...
		<label id="f" class="logout4"> Amount : </label><br/>
	 ...
	 <a href="shoppingdetails.php" class="logout " style="background-color:black;color:red">Click next >><a/><br/><br/><br/>
    <div class="logout6">
       <?php echo $error ?>
    </div>
